README
------
Code for the paper entitled "Evolving Through the Looking Glass: Learning Improved Search Spaces with Variational Autoencoders"
Naming still reflects original project COIL; since renamed to SOLVE in the paper.
...
│   ├── c1.py         		# Specifies objective, criterion and settings for C1
│   ├── c2.py          		# Specifies objective, criterion and settings for C2
│   ├── c3.py         		# Specifies objective, criterion and settings for C3
...
│   ├── cmulti_2c.py         		# Specifies objective, criterion and settings for C4.1,C4.2
│   ├── cmulti_3c.py         		# Specifies objective, criterion and settings for C4.1,C4.2,C4.3
│   ├── cmulti_4c.py         		# Specifies objective, criterion and settings for C4.1,C4.2,C4.3,C4.4
│   ├── cmulti_c1243_2c.py     		# Specifies objective, criterion and settings for C4.1,C4.2
│   ├── cmulti_c1243_3c.py     		# Specifies objective, criterion and settings for C4.1,C4.2,C4.4
│   ├── cmulti_c1243_4c.py     		# Specifies objective, criterion and settings for C4.1,C4.2,C4.4,C4.3
│   ├── generate_data_c0.py		# Generates data for the first criterion c0
│   ├── generate_data_cn.py		# Generates data for the other criteria
│   ├── learn_representation_c0n.py	# Learn representation for criterion c0..cn
...
* To run StackedCOIL on C4 for 2 criteria (cmulti_2c.py) (note we always use 4 variables)
...
│   ├── cdiscon.py         		# Specifies objective, criterion and settings for C5
